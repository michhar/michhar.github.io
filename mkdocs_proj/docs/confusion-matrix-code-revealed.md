...
![header pic](/img/cm_lets_python.jpg)
...
![show training workflow](/img/cm_workflow.png)
...
![show opening as notebook](/img/cm_open_as_notebook.png)
...
![show the matrices](/img/confusion_matrices.png)
...
Thanks for reading, check out the sample (static) jupyter notebook [here](hhttps://github.com/michhar/python-jupyter-notebooks/blob/master/azure_machine_learning/A_Simple_Confusion_Matrix.ipynb) and best of luck with those confusion matrices!
